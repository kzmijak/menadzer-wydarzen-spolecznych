...
namespace MWS.Procedures
{
    class PSetPracownik : DatabaseObjectProcedures
    {
        ...
        public List<DatabaseObject> GetCollection()
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(DbHelper.CnnVal("cnMWS")))
            {
                return connection.Query<DatabaseObject>("dbo.Pracownik_GetCollection").ToList();
            }
        }
        ...
        public DatabaseObject GetRecord(DatabaseObject dbobject)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(DbHelper.CnnVal("cnMWS")))
            {
                return connection.Query<DatabaseObject>("dbo.Pracownik_GetRecord @id", dbobject).ToList()[0];
            }
        }
        ...
        public DatabaseObject GetRecordById(int id)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(DbHelper.CnnVal("cnMWS")))
            {
                return connection.Query<DatabaseObject>("dbo.Pracownik_GetRecord @id", new { id }).ToList()[0];
            }
        }
        ...
        public void Insert(DatabaseObject dbobject)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(DbHelper.CnnVal("cnMWS")))
            {
                connection.Execute("dbo.Pracowni_Insert @stanowisko, @wynagrodzenie", dbobject);
            }
        }
        ...
        public void Update(DatabaseObject dbobject_old, DatabaseObject dbobject_new)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(DbHelper.CnnVal("cnMWS")))
            {
                connection.Execute("dbo.Pracowin_Update @id, @stanowisko, @wynagrodzenie", dbobject_new);
            }
        }
    }
}
